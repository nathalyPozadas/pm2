    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    @if(isset($tratamiento))
                    <form method="post" action="{{  route('tratamiento.update',['id'=>$tratamiento->id]) }}" enctype="multipart/form-data" autocomplete="off">
                    @else
                    <form method="post" action="{{ route('tratamiento.store') }}" enctype="multipart/form-data" autocomplete="off">
                    @endif
                        @csrf
                        @method('post')
