...
@foreach ($detalles as $implante)
    <br>
    <h3>RESUMEN IMPLANTE #{{$implante['implante']->id}}</h3>
    <div>
        <div class="container">
            <table class="minimalistBlack">
                ...
                <tbody>
                    <tr>
                        <td style="text-align: center">{{$implante['implante']->id}}</td>
                        <td style="text-align: center">{{$implante['implante']->pieza}}</td>
                        <td style="text-align: center">{{$implante['implante']->fecha}}</td>
                        <td style="text-align: center">{{$implante['tornillo']->nombre}}</td>
                        <td style="text-align: center">{{$implante['implante']->marca}}</td>
                        <td style="text-align: center">{{$implante['implante']->medida}}</td>
                        <td style="text-align: center">{{$implante['implante']->costo}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <h4>Implante#{{$implante['implante']->id}}</h4>
            <div>
                @if(count($implante['acciones'])>0)
                    <table class="minimalistBlack">
                        <thead>
                        <tr>
                            <th>FECHA</th>
                        ...
                        <tbody>
                            @foreach($implante['acciones'] as $accion)
                                <tr>
        ...
        <div>
            @if(count($implante['pagos'])>0)
                <table class="minimalistBlack">
                    ...
                    <tbody>
                    @foreach($implante['pagos'] as $pago)
                        <tr>
